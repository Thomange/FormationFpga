...
# Pmod Header JA
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports {output_data[0]}]
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports {output_data[1]}]
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports {output_data[2]}]
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports {output_data[3]}]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {output_data[4]}]
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {output_data[5]}]
set_property -dict {PACKAGE_PIN W18 IOSTANDARD LVCMOS33} [get_ports {output_data[6]}]
set_property -dict {PACKAGE_PIN W19 IOSTANDARD LVCMOS33} [get_ports {output_data[7]}]

### Pmod Header JB
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports    {input_data[0] }]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports    {input_data[1] }]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports    {input_data[2] }]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports    {input_data[3] }]
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports    {input_data[4] }]
set_property -dict {PACKAGE_PIN W16 IOSTANDARD LVCMOS33} [get_ports    {input_data[5] }]
set_property -dict { PACKAGE_PIN V12 IOSTANDARD LVCMOS33 } [get_ports  {input_data[6] }]; #IO_L4P_T0_34 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN W13 IOSTANDARD LVCMOS33 } [get_ports  {input_data[7] }]; #IO_L4N_T0_34 Sch=jb_n[4]
...
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS33 } [get_ports {input_data_valid }]; #IO_L9P_T1_DQS_AD3P_35 Sch=user_dio[1]
set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports {output_data_valid }]; #IO_L7P_T1_AD2P_35 Sch=user_dio[2]
#set_property -dict { PACKAGE_PIN N20   IOSTANDARD LVCMOS33 } [get_ports {input_data[2] }]; #IO_L14P_T2_SRCC_34 Sch=user_dio[3]
#set_property -dict { PACKAGE_PIN P20   IOSTANDARD LVCMOS33 } [get_ports {input_data[3] }]; #IO_L14N_T2_SRCC_34 Sch=user_dio[4]
#set_property -dict { PACKAGE_PIN P19   IOSTANDARD LVCMOS33 } [get_ports {input_data[4] }]; #IO_L13N_T2_MRCC_34 Sch=user_dio[5]
#set_property -dict { PACKAGE_PIN R19   IOSTANDARD LVCMOS33 } [get_ports {input_data[5] }]; #IO_0_34 Sch=user_dio[6]
#set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33 } [get_ports {input_data[6] }]; #IO_L15P_T2_DQS_34 Sch=user_dio[7]
#set_property -dict { PACKAGE_PIN T19   IOSTANDARD LVCMOS33 } [get_ports {input_data[7] }]; #IO_25_34 Sch=user_dio[8]
#set_property -dict { PACKAGE_PIN U20   IOSTANDARD LVCMOS33 } [get_ports { input_data_valid }]; #IO_L15N_T2_DQS_34 Sch=user_dio[9]
