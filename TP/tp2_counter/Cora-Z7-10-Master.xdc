...
#set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports end_counter]
...
# Buttons
set_property -dict {PACKAGE_PIN D20 IOSTANDARD LVCMOS33} [get_ports btn_restart]
...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { end_counter }]; #IO_L11P_T1_SRCC_34 Sch=ck_io[0]
...
#set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports resetn]
